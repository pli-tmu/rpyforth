\ Transition table generation - Regular expression to DFA

.( Loading TransitionTable.fth ...) cr
...
\ Definition of transition table row sizes
\ values as they will be set up by user code
