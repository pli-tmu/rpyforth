\ SyntaxTree.fth - builds a syntax tree for a regular expression
...
\ Empty leaf nodes don't seem to be needed, therefore omitted for now
...
\ *** Beware - this code has not yet been tested
...
\ -----------------------------------------------------------------------------
\ Base class for concatenation and | operator
...
\ -----------------------------------------------------------------------------
\ Base class for * and ? operators and node generated by + operator
...
\ -----------------------------------------------------------------------------
\ For + operator, there is not a PlusNode as such.
