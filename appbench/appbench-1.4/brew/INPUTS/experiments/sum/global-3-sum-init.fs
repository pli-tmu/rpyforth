\ global-3-sum-init.fs
\ 	$Id: global-3-sum-init.fs,v 1.6 2005/04/10 16:20:26 f Exp $	
...
\ ok, but very slow:
: g-3542
    integer-D@ integer-B@ + integer-C@ + organ-A ! ;

\ watch code length decrease.
...
s" Initialisation file 'global-3-sum-init.fs' included.  Experiment ready."
1 >message
