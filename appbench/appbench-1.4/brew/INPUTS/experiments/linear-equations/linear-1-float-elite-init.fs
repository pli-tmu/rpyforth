\ linear-1-float-elite-init.fs
\ 	$Id: linear-1-float-elite-init.fs,v 1.6 2005/04/10 16:20:20 f Exp $	
...
GENE: g-13891
    D-f-property@ fdup C-f-property@ f/ f-organ-B df! f-organ-A df!
;gene
...
s" Initialisation file 'linear-1-float-elite-init.fs' included.  Experiment ready."
1 >message
