\ linear-1-float-init.fs
\ 	$Id: linear-1-float-init.fs,v 1.12 2005/04/10 16:20:21 f Exp $	
\ Initialisation file for linear-1-float.fs


\ 'brew' recorded evolutionary session playback file.
\
\  created with brew version:
\ 	brew.fs,v 1.308 2002/02/16 07:21:28 f 
\ 	genes-0.3.fs,v 1.14 2002/02/14 12:19:59 f 
\ 	mutation-0.3.fs,v 1.31 2002/02/14 12:49:00 f 
...
s" INPUTS/experiments/linear-equations/linear-1-float.fs" required

false [IF] \ results:
    This was more luck than evolution:
    \ spot:1912 step:442 mother ID:97591
    : mutation.442:1912.GI:666.to-GI:945 ( -- )
...
-970294959 seed-BRODIE !	 \ gets recorded changed or not 8
...
\ 500000 world-food-supply !
1000000 world-food-supply !
500 food-share/spot !
...
0 |C OR |D OR  f-properties-div-mask !
0  f-secrets-div-mask !
' spot-f-diversification-range buffered" 50e0  0 0 0 0 0 0 49 40 " buffered-float!
' spot-f-diversification-factor buffered" 2e0  0 0 0 0 0 0 0 40 " buffered-float!
...
0 (scan-index) !	\ unique: 401639486C04013F1684013F1D0100005141
...
1 (scan-index) !	\ unique: 4016394811CC4013F1684013F1D0464641F40645141
' nuc-scan-display (scan-xt) !
17 (scan-detail) !
12 (scan-lines) !
' blue scan-background-xt !
' default-color scan-foreground-xt !
100 1000 (scan-min-max) 2!
100 8100 (last-scan-min-max) 2!
1 5 horizontal-zoom-scale 2!
1 4 vertical-zoom-scale 2!
12 (vertical-display-range) !
0 fixed-horizontal-range OR  (scan-flags) !
2 (scan-index) !	\ unique: 00004013F1D04013F1D0000005100
0 (scan-xt) !
0 (scan-detail) !
0 (scan-lines) !
...
0 (vertical-display-range) !
0  (scan-flags) !
3 (scan-index) !	\ unique: 00004013F1D04013F1D0000005100
0 (scan-xt) !
0 (scan-detail) !
0 (scan-lines) !
' default-color scan-background-xt !
...
0 (vertical-display-range) !
0  (scan-flags) !
4 (scan-index) !	\ unique: 00004013F1D04013F1D0000005100
0 (scan-xt) !
0 (scan-detail) !
0 (scan-lines) !
' default-color scan-background-xt !
...
0 (vertical-display-range) !
0  (scan-flags) !
5 (scan-index) !	\ unique: 00004013F1D04013F1D0000005100
0 (scan-xt) !
0 (scan-detail) !
0 (scan-lines) !
' default-color scan-background-xt !
...
0 (vertical-display-range) !
0  (scan-flags) !
6 (scan-index) !	\ unique: 00004013F1D04013F1D0000005100
0 (scan-xt) !
0 (scan-detail) !
0 (scan-lines) !
' default-color scan-background-xt !
...
0 (vertical-display-range) !
0  (scan-flags) !
7 (scan-index) !	\ unique: 00004013F1D04013F1D0000005100
0 (scan-xt) !
0 (scan-detail) !
0 (scan-lines) !
' default-color scan-background-xt !
...
0 (vertical-display-range) !
0  (scan-flags) !
8 (scan-index) !	\ unique: 00004013F1D04013F1D0000005100
0 (scan-xt) !
0 (scan-detail) !
0 (scan-lines) !
' default-color scan-background-xt !
...
0 (vertical-display-range) !
0  (scan-flags) !
9 (scan-index) !	\ unique: 00004013F1D04013F1D0000005100
0 (scan-xt) !
0 (scan-detail) !
0 (scan-lines) !
' default-color scan-background-xt !
...
0 (vertical-display-range) !
0  (scan-flags) !
10 (scan-index) !	\ unique: 00004013F1D04013F1D0000005100
0 (scan-xt) !
0 (scan-detail) !
0 (scan-lines) !
' default-color scan-background-xt !
...
0 (vertical-display-range) !
0  (scan-flags) !
11 (scan-index) !	\ unique: 00004013F1D04013F1D0000005100
0 (scan-xt) !
0 (scan-detail) !
0 (scan-lines) !
' default-color scan-background-xt !
...
1000 	internal+' g-IF-ELSE-THEN	actual-genepool-xt @ execute set-one
...
0 	internal+' organ-A	actual-genepool-xt @ execute set-one
...
2500 	internal+' f-organ-A	actual-genepool-xt @ execute set-one
2500 	internal+' f-organ-B	actual-genepool-xt @ execute set-one
...
3000 	internal+' C-f-property@	actual-genepool-xt @ execute set-one
3000 	internal+' D-f-property@	actual-genepool-xt @ execute set-one
1000 	internal+' df@	actual-genepool-xt @ execute set-one
0 	internal+' f-take	actual-genepool-xt @ execute set-one
3000 	internal+' df!	actual-genepool-xt @ execute set-one
1000 	internal+' df+!	actual-genepool-xt @ execute set-one
1000 	internal+' df-!	actual-genepool-xt @ execute set-one
1000 	internal+' fdup	actual-genepool-xt @ execute set-one
0 	internal+' fdrop	actual-genepool-xt @ execute set-one
0 	internal+' drop(float-pointer)	actual-genepool-xt @ execute set-one
1000 	internal+' fswap	actual-genepool-xt @ execute set-one
1000 	internal+' fover	actual-genepool-xt @ execute set-one
0 	internal+' frot	actual-genepool-xt @ execute set-one
1000 	internal+' f+	actual-genepool-xt @ execute set-one
1000 	internal+' f-	actual-genepool-xt @ execute set-one
1000 	internal+' f*	actual-genepool-xt @ execute set-one
1000 	internal+' f/	actual-genepool-xt @ execute set-one
1000 	internal+' fnegate	actual-genepool-xt @ execute set-one
...
0 	internal+' f2/	actual-genepool-xt @ execute set-one
1000 	internal+' 1/f	actual-genepool-xt @ execute set-one
...
s" Initialisation file 'linear-1-float-init.fs' included.  Experiment ready."
1 >message
