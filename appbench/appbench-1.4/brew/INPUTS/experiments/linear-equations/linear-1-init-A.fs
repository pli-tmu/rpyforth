\ linear-1-init-A.fs
\ 	$Id: linear-1-init-A.fs,v 1.11 2005/04/10 16:20:22 f Exp $	
...
: g-517
    organ-A take organ-B ! ;

: g-17031
    organ-A @ D-property@ organ-A ! C-property@ ?/ organ-B ! ;

: g-42491
    organ-A @ negate organ-A -!(some) organ-A @ D-property@ organ-A !
    C-property@ ?/ organ-B ! ;

\ This one seems to be better than my cheat...
: g-106917
    D-property@ negate organ-A -!(some) organ-A @ D-property@ organ-A !
    C-property@ ?/ organ-B ! ;
...
\ Another run, starting with my cheat:
\ : g-139105
\     D-property@ organ-A +!(some) organ-A @ D-property@ organ-A !
\     C-property@ ?/ organ-B ! ;
...
50000 	internal' organ-A	actual-genepool-xt @ execute set-one
50000 	internal' organ-B	actual-genepool-xt @ execute set-one
30000 	internal' organ-C	actual-genepool-xt @ execute set-one
...
50000 	internal' D-property@	actual-genepool-xt @ execute set-one
...
s" Initialisation file 'linear-1-init-A.fs' included.  Experiment ready."
1 >message
