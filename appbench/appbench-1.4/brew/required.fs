...
\ This file is from the Gforth distribution.
...
\ As I chequed for REQUIRED before including this file I comment this out
\ ( as FORTH-WORDLIST was not found in a system I use).
