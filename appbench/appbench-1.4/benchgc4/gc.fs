...
\ aus, cells, floats and dfloats have sizes (in bits) that are powers of 2
...
variable other-roots 0 other-roots !
...
variable freelists freelist-sentinel freelists ! \ list of freelists
...
0 current-limit !
2variable size-factor 3 1 size-factor 2! \ a fraction; the default is 3/1
variable size-offset 32 1024 * size-offset ! \ number of grains
variable live-grains 0 live-grains ! \ grains live after last collection
...
( u-size f-verbosity f-deep-stacks )
