...
SHOOTOUT_BENCHMARKS = [
    ...
    {"id": "hello", "title": "Hello world", "original": "hello.gforth",
     "path": "shootout/hello.fs", "phase": 1, "status": "supported", "required": set()},
    {"id": "sumcol", "title": "Sum a column of integers", "original": "sumcol.gforth",
     "path": "shootout/sumcol.fs", "phase": 1, "status": "supported",
     "required": {"READ-LINE", "STDIN"}},
    {"id": "strcat", "title": "String concatenation", "original": "strcat.gforth",
     "path": "shootout/strcat.fs", "phase": 1, "status": "supported",
     "required": {"ALLOCATE", "RESIZE", "CMOVE>"}},
    {"id": "reversefile", "title": "Reverse lines from stdin", "original": "reversefile.gforth",
     "path": "shootout/reversefile.fs", "phase": 1, "status": "supported",
     "required": {"READ-FILE", "WRITE-FILE", "ALLOCATE", "STDIN", "STDOUT"}},
    {"id": "wc", "title": "Word / line / char count", "original": "wc.gforth",
     "path": "shootout/wc.fs", "phase": 1, "status": "supported",
     "required": {"READ-FILE", "STDIN", "CASE", "OF", "ENDOF", "ENDCASE"}},
    {"id": "except", "title": "Exception handling", "original": "except.gforth",
     "path": "shootout/except.fs", "phase": 2, "status": "supported",
     "required": {"CATCH", "THROW"}},
    {"id": "random", "title": "Random numbers", "original": "random.gforth",
     "path": "shootout/random.fs", "phase": 2, "status": "supported",
     "required": set()},
    {"id": "hash", "title": "Hash table (int keys)", "original": "hash.gforth",
     "path": "shootout/hash.fs", "phase": 3, "status": "supported",
     "required": {"WORDLIST", "SEARCH-WORDLIST", "NEXTNAME",
                  "GET-CURRENT", "SET-CURRENT", "?DO"}},
    {"id": "hash2", "title": "Hash table (two-level)", "original": "hash2.gforth",
     "path": "shootout/hash2.fs", "phase": 3, "status": "supported",
     "required": {"WORDLIST", "SEARCH-WORDLIST", "NEXTNAME",
                  "GET-CURRENT", "SET-CURRENT", ">ORDER", "PREVIOUS", "?DO"}},
    {"id": "spellcheck", "title": "Spell checker", "original": "spellcheck.gforth",
     "path": "shootout/spellcheck.fs", "phase": 3, "status": "supported",
     "required": {"OPEN-FILE", "READ-LINE", "WORDLIST", "SEARCH-WORDLIST",
                  "NEXTNAME", "GET-CURRENT", "SET-CURRENT", "STDIN"}},
    {"id": "wordfreq", "title": "Word frequency count", "original": "wordfreq.gforth",
     "path": "shootout/wordfreq.fs", "phase": 3, "status": "supported",
     "required": {"WORDLIST", "SEARCH-WORDLIST", "NEXTNAME",
                  "GET-CURRENT", "SET-CURRENT", "READ-LINE", "STDIN"}},
    {"id": "lists", "title": "Linked list operations", "original": "lists.gforth",
     "path": "shootout/lists.fs", "phase": 4, "status": "supported",
     "required": {"STRUCT", "END-STRUCT", "FIELD", "CELL%", "%ALLOC", "?DO"}},
    {"id": "moments", "title": "Statistical moments", "original": "moments.gforth",
     "path": "shootout/moments.fs", "phase": 4, "status": "supported",
     "required": {"READ-LINE", "STDIN", "S>F", "F.", "FLOATS"}},
    {"id": "matrix", "title": "Matrix multiplication", "original": "matrix.gforth",
     "path": "shootout/matrix.fs", "phase": 5, "status": "supported",
     "required": set()},
    {"id": "methcall", "title": "Method calls (OO)", "original": "methcall.gforth",
     "path": "shootout/methcall.fs", "phase": 6, "status": "supported",
     "required": set()},
    {"id": "objinst", "title": "Object instantiation (OO)", "original": "objinst.gforth",
     "path": "shootout/objinst.fs", "phase": 6, "status": "supported",
     "required": set()},
    ...
    {"id": "regexmatch", "title": "Regex / phone number scan", "original": "regexmatch.gforth",
     ...
     "required": {"REQUIRE", "GRAY", "READ-FILE", "STDIN"}},
]
